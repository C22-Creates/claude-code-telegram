...
class ClaudeTaskRunnerModelPassthroughTest(unittest.IsolatedAsyncioTestCase):
    async def test_resolved_model_is_passed_to_run_command(self):
        ...
        task = {
            ...
            "payload": {"role": "recap", "sessionId": "abc"},
        }
